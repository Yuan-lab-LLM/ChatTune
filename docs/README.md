...
3. [Admin Guide](ADMIN_GUIDE.md): after the first Studio login, create users and groups, bind containers, and configure GPU resource pools.
4. [User Guide](USER_GUIDE.md): log in as an ordinary user and run natural-language commands, one-click workflows, training, evaluation, inference, and task-control commands.

## Extended Docs

- [Multi-node Configuration](MULTI_NODE.md): center node, compute node, multi-node token, and URL configuration.
