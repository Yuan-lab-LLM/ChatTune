import { Key, memo, MouseEvent, useEffect, useRef, useState } from 'react';
...
const ProjectPage = () => {
    ...
    // Auto-navigate to the latest project when data is loaded
    useEffect(() => {
        if (
            ...
            const sortedProjects = [...tableDataSource].sort(
                (a, b) =>
            ...
            if (latestProject) {
                navigate(`/projects/${latestProject.project}`);
            }
        }
    }, [tableDataSource, tableLoading, navigate]);
