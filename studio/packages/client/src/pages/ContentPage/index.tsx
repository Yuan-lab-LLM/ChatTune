...
const blockTones = {
    blue: {
        card: 'border-sky-200/70 bg-sky-50/85 shadow-sky-100/70',
        accent: 'bg-sky-500',
        icon: 'bg-sky-100 text-sky-700 border-sky-200/80',
        number: 'text-sky-900',
    },
    emerald: {
        card: 'border-emerald-200/70 bg-emerald-50/85 shadow-emerald-100/70',
        accent: 'bg-emerald-500',
        icon: 'bg-emerald-100 text-emerald-700 border-emerald-200/80',
        number: 'text-emerald-900',
    },
    amber: {
        card: 'border-amber-200/80 bg-amber-50/85 shadow-amber-100/70',
        accent: 'bg-amber-500',
        icon: 'bg-amber-100 text-amber-700 border-amber-200/80',
        number: 'text-amber-900',
    },
    rose: {
        card: 'border-rose-200/70 bg-rose-50/85 shadow-rose-100/70',
        accent: 'bg-rose-500',
...
const Block = ({ title, number, footer, icon, tone }: BlockProps) => {
    const toneClasses = blockTones[tone];

    return (
        <div
            className={cn(
                'home-stat-card relative overflow-hidden rounded-lg border p-5 h-full flex flex-col gap-2 shadow-sm',
                toneClasses.card,
            )}
        >
            <div className={cn('absolute inset-y-0 left-0 w-1', toneClasses.accent)} />
            ...
            <div className="flex flex-col gap-0">
                {number !== undefined ? (
                    <div className={toneClasses.number}>
                        <NumberCounter
                            number={number}
