...
export const StatusCell = memo(
    ({ status, selected }: { status: Status; selected: boolean }) => {
        ...
        return (
            <div
                className={`text-[11px] flex flex-row items-center gap-1 w-fit pl-1.5 pr-2 py-[3px] rounded-full border ${
                    selected
                        ? 'border-sky-200/80 bg-white/82 text-slate-700 shadow-[0_8px_18px_-16px_rgba(15,23,42,0.24)]'
